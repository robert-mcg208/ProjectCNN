...
# Define paths
train_dir = r"C:\Users\rober\Documents\Uni\Year4\Honours\Project\dataset\data\memory\train"  
test_dir = r"C:\Users\rober\Documents\Uni\Year4\Honours\Project\dataset\data\memory\test"    
save_dir = r"C:\Users\rober\Documents\Uni\Year4\Honours\Project\CNN\FINISHED\results"  
...
# Build CNN 
my_model = Sequential([
    Conv2D(64, (3,3), activation='relu', strides = (2,2), input_shape=(img_height, img_width, 3)),
    ...
    Dense(64, activation='relu', kernel_regularizer=regularizers.l2(0.015)),
    Dropout(0.25),
...
# Save model
my_model_save_path = os.path.join(save_dir, "dynamic_model.keras")
